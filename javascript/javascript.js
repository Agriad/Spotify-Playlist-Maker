...
function test() {
  getSpotifySecret()
    .then((spotifySecret) => {
      ...
      return requestAuthorizationSpotify(spotifySecret);
    })
    .then((clientData) => {
      console.log(clientData);
      return requestRefreshAccessToken(clientData);

      // console.log(spotifyAccessToken);
      //   console.log(clientData);
      //   clientData = JSON.parse(clientData);
      //   let json = JSON.stringify({artist : "muse", title : "uprising", clientID : clientData.clientID, clientSecret : clientData.clientSecret, redirectURI : clientData.redirectURI, accessToken : clientData.accessToken});

      //   // let json = JSON.stringify({artist : "muse", title : "uprising", spotifyAccessToken : spotifyAccessToken});
